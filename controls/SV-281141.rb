control 'SV-281141' do
  title 'RHEL 10 must generate audit records for successful and unsuccessful uses of the "sudo" command.'
...
'
  desc 'check', %q(Verify RHEL 10 is configured to audit the execution of the "sudo" command with the following command:
...
If the command does not return a line, or the line is commented out, this is a finding.)
  desc 'fix', 'Configure RHEL 10 to generate audit records upon successful and unsuccessful attempts to use the "sudo" command by adding or updating the following rule in "/etc/audit/rules.d/audit.rules":
...
$ sudo service auditd restart'
  impact 0.5
  tag check_id: 'C-85702r1166373_chk'
  tag severity: 'medium'
  tag gid: 'V-281141'
  tag rid: 'SV-281141r1197230_rule'
  tag stig_id: 'RHEL-10-500550'
  tag gtitle: 'SRG-OS-000037-GPOS-00015'
  tag fix_id: 'F-85607r1166374_fix'
  tag satisfies: ['SRG-OS-000037-GPOS-00015', 'SRG-OS-000042-GPOS-00020', 'SRG-OS-000062-GPOS-00031', 'SRG-OS-000392-GPOS-00172', 'SRG-OS-000462-GPOS-00206', 'SRG-OS-000471-GPOS-00215', 'SRG-OS-000466-GPOS-00210', 'SRG-OS-000755-GPOS-00220']
  tag 'documentable'
