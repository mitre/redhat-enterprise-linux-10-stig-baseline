control 'SV-280978' do
  title 'RHEL 10 must use cryptographic mechanisms to protect the integrity of audit tools.'
...
To address this risk, audit tools must be cryptographically signed to provide the capability to identify when the audit tools have been modified, manipulated, or replaced. An example is a checksum hash of the file or files.'
  desc 'check', 'Verify RHEL 10 Advanced Intrusion Detection Environment (AIDE) is properly configured to protect the integrity of the audit tools.
...
If there is no evidence of integrity protection, this is a finding.'
  desc 'fix', 'Configure RHEL 10 to use cryptographic mechanisms to protect the integrity of audit tools.
...
/usr/sbin/augenrules p+i+n+u+g+s+b+acl+xattrs+sha512'
  ...
  tag gid: 'V-280978'
  tag rid: 'SV-280978r1165289_rule'
  tag stig_id: 'RHEL-10-200631'
  tag fix_id: 'F-85444r1165288_fix'
