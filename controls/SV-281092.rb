control 'SV-281092' do
  ...
  desc 'check', 'Verify RHEL 10 is configured so that "/var/log/audit" is mounted with the "noexec" option:
...
If the "/var/log/audit" file system is mounted without the "noexec" option, this is a finding.'
  desc 'fix', 'Configure RHEL 10 to mount "/var/log/audit" with the "noexec" option.
...
Modify "/etc/fstab" to use the "noexec" option on the "/var/log/audit" directory.'
  ...
  tag gid: 'V-281092'
  tag rid: 'SV-281092r1165631_rule'
  tag stig_id: 'RHEL-10-400405'
  tag fix_id: 'F-85558r1165630_fix'
  tag cci: ['CCI-001764']
  tag nist: ['CM-7 (2)']
  tag 'host'
