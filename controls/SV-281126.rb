control 'SV-281126' do
  title 'RHEL 10 must generate audit records for successful and unsuccessful uses of the "delete_module" system call.'
...
'
  desc 'check', 'Verify RHEL 10 is configured to audit the execution of the "delete_module" system call with the following command:
...
If both the "b32" and "b64" audit rules are not defined for the "delete_module" system call, or any of the lines returned are commented out, this is a finding.'
  desc 'fix', 'Configure RHEL 10 to generate audit records upon successful and unsuccessful use of the "delete_module" system call by adding or updating the following rules in the "/etc/audit/rules.d/audit.rules" file:
...
$ sudo service auditd restart'
  impact 0.5
  tag check_id: 'C-85687r1166328_chk'
  tag severity: 'medium'
  tag gid: 'V-281126'
  tag rid: 'SV-281126r1166330_rule'
  tag stig_id: 'RHEL-10-500400'
  tag gtitle: 'SRG-OS-000037-GPOS-00015'
  tag fix_id: 'F-85592r1166329_fix'
