control 'SV-281147' do
  title 'RHEL 10 must generate audit records for successful and unsuccessful uses of the "mount" command.'
...
'
  desc 'check', 'Verify RHEL 10 is configured to audit the execution of the "mount" command with the following command:
...
If the command does not return a line, or the line is commented out, this is a finding.'
  desc 'fix', 'Configure RHEL 10 to generate audit records upon successful and unsuccessful attempts to use the "mount" command by adding or updating the following rule in "/etc/audit/rules.d/audit.rules":
...
$ sudo service auditd restart'
  impact 0.5
  tag check_id: 'C-85708r1166391_chk'
  tag severity: 'medium'
  tag gid: 'V-281147'
  tag rid: 'SV-281147r1166393_rule'
  tag stig_id: 'RHEL-10-500610'
  tag gtitle: 'SRG-OS-000037-GPOS-00015'
  tag fix_id: 'F-85613r1166392_fix'
