control 'SV-281129' do
  title 'RHEL 10 must generate audit records for successful and unsuccessful uses of the "chsh" command.'
...
'
  desc 'check', 'Verify RHEL 10 is configured to audit the execution of the "chsh" command with the following command:

$ sudo auditctl -l | grep chsh
-a always,exit -S all -F path=/usr/bin/chsh -F perm=x -F auid>=1000 -F auid!=-1 -F key=priv_cmd

If the command does not return a line, or the line is commented out, this is a finding.'
  desc 'fix', 'Configure RHEL 10 to generate audit records upon successful and unsuccessful attempts to use the "chsh" command by adding or updating the following rule in "/etc/audit/rules.d/audit.rules":
...
$ sudo service auditd restart'
  impact 0.5
  tag check_id: 'C-85690r1166337_chk'
  tag severity: 'medium'
  tag gid: 'V-281129'
  tag rid: 'SV-281129r1166339_rule'
  tag stig_id: 'RHEL-10-500430'
  tag gtitle: 'SRG-OS-000037-GPOS-00015'
  tag fix_id: 'F-85595r1166338_fix'
