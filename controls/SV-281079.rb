control 'SV-281079' do
  ...
  desc 'check', %q(Verify RHEL 10 sets the default umask for all local interactive users to "077".
...
If any local interactive user initialization files are found to have a umask statement that sets a value less restrictive than "077", this is a finding.)
  desc 'fix', %q(Configure RHEL 10 to set the umask value for all local interactive user accounts to "077".
