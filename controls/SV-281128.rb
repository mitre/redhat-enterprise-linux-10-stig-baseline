control 'SV-281128' do
  title 'RHEL 10 must generate audit records for successful and unsuccessful uses of the "chage" command.'
...
'
  desc 'check', 'Verify RHEL 10 is configured to audit the execution of the "chage" command with the following command:
...
If the command does not return a line, or the line is commented out, this is a finding.'
  desc 'fix', 'Configure RHEL 10 to generate audit records upon successful and unsuccessful attempts to use the "chage" command by adding or updating the following rule in "/etc/audit/rules.d/audit.rules":
...
$ sudo service auditd restart'
  impact 0.5
  tag check_id: 'C-85689r1166334_chk'
  tag severity: 'medium'
  tag gid: 'V-281128'
  tag rid: 'SV-281128r1166336_rule'
  tag stig_id: 'RHEL-10-500420'
  tag gtitle: 'SRG-OS-000037-GPOS-00015'
  tag fix_id: 'F-85594r1166335_fix'
