control 'SV-281145' do
  title 'RHEL 10 must generate audit records for successful and unsuccessful uses of the "userhelper" command.'
...
'
  desc 'check', 'Verify RHEL 10 is configured to audit the execution of the "userhelper" command with the following command:
...
If the command does not return a line, or the line is commented out, this is a finding.'
  desc 'fix', 'Configure RHEL 10 to generate audit records upon successful and unsuccessful attempts to use the "userhelper" command by adding or updating the following rule in "/etc/audit/rules.d/audit.rules":
...
$ sudo service auditd restart'
  impact 0.5
  tag check_id: 'C-85706r1166385_chk'
  tag severity: 'medium'
  tag gid: 'V-281145'
  tag rid: 'SV-281145r1197233_rule'
  tag stig_id: 'RHEL-10-500590'
  tag gtitle: 'SRG-OS-000037-GPOS-00015'
  tag fix_id: 'F-85611r1166386_fix'
