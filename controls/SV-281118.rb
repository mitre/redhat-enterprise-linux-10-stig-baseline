control 'SV-281118' do
  title 'RHEL 10 must generate audit records for successful and unsuccessful uses of "umount" system calls.'
...
'
  desc 'check', 'Verify RHEL 10 is configured to audit the execution of the "umount" command with the following command:
...
If the command does not return an audit rule for "umount", or any of the lines returned are commented out, this is a finding.'
  desc 'fix', 'Configure RHEL 10 to generate audit records upon successful and unsuccessful attempts to use the "umount" command by adding or updating the following rules in "/etc/audit/rules.d/audit.rules":
...
$ sudo service auditd restart'
  impact 0.5
  tag check_id: 'C-85679r1166304_chk'
  tag severity: 'medium'
  tag gid: 'V-281118'
  tag rid: 'SV-281118r1166306_rule'
  tag stig_id: 'RHEL-10-500320'
  tag gtitle: 'SRG-OS-000037-GPOS-00015'
  tag fix_id: 'F-85584r1166305_fix'
