control 'SV-281152' do
  ...
  desc 'check', %q(Verify RHEL 10 generates an audit record for all uses of the "umount" system call with the following command:
