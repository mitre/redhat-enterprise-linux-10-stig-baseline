control 'SV-281135' do
  title 'RHEL 10 must generate audit records for successful and unsuccessful uses of the "passwd" command.'
...
'
  desc 'check', %q(Verify RHEL 10 generates audit records for all account creations, modifications, disabling, and termination events that affect "/etc/passwd" with the following command:
...
If the command does not return a line, or the line is commented out, this is a finding.)
  desc 'fix', 'Configure RHEL 10 to generate audit records upon successful and unsuccessful attempts to use the "passwd" command by adding or updating the following rule in "/etc/audit/rules.d/audit.rules":
...
$ sudo service auditd restart'
  impact 0.5
  tag check_id: 'C-85696r1184692_chk'
  tag severity: 'medium'
  tag gid: 'V-281135'
  tag rid: 'SV-281135r1184693_rule'
  tag stig_id: 'RHEL-10-500490'
  tag gtitle: 'SRG-OS-000037-GPOS-00015'
  tag fix_id: 'F-85601r1166356_fix'
