...
This requirement applies to the globally configured system defaults and the local interactive user defaults for each account on the system.'
  desc 'check', 'Verify the RHEL 10 "umask" setting is configured correctly in the "/etc/profile" file with the following command:
...
umask 077'
  impact 0.5
  tag check_id: 'C-85644r1184688_chk'
  tag severity: 'medium'
  tag gid: 'V-281083'
