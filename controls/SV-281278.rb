control 'SV-281278' do
  title 'RHEL 10 must automatically lock graphical user sessions after 10 minutes of inactivity.'
...
If "idle-delay" is set to "0" or a value greater than "600", this is a finding.'
  desc 'fix', 'Configure RHEL 10 to initiate a screensaver after a 10-minute period of inactivity for graphical user interfaces.
...
$ sudo dconf update'
  ...
  tag gid: 'V-281278'
  tag rid: 'SV-281278r1208799_rule'
  tag stig_id: 'RHEL-10-700750'
  tag fix_id: 'F-85744r1208373_fix'
