...
Setting the password maximum age ensures users are required to periodically change their passwords. Requiring shorter password lifetimes increases the risk of users writing down the password in a convenient location subject to physical compromise.'
  desc 'check', 'Verify RHEL 10 enforces a 60-day maximum password lifetime for new user accounts by running the following command:
...
If the "PASS_MAX_DAYS" parameter value is greater than "60" or is commented out, this is a finding.'
  desc 'fix', 'Configure RHEL 10 to enforce a 60-day maximum password lifetime.
