...
Password protection on the boot loader configuration ensures users with physical access cannot trivially alter important bootloader settings. These include which kernel to use and whether to enter single-user mode.'
  desc 'check', 'Verify RHEL 10 requires a boot loader superuser password with the following command:
...
If a "GRUB2_PASSWORD" is not set, this is a finding.'
  desc 'fix', 'Configure RHEL 10 to require a grub bootloader password for the grub superuser account.
...
Confirm password:'
  impact 0.5
  tag check_id: 'C-85727r1166448_chk'
  tag severity: 'medium'
  tag gid: 'V-281166'
  tag rid: 'SV-281166r1166450_rule'
  tag stig_id: 'RHEL-10-600000'
  tag gtitle: 'SRG-OS-000080-GPOS-00048'
  tag fix_id: 'F-85632r1166449_fix'
  tag 'documentable'
  tag cci: ['CCI-000213']
  tag nist: ['AC-3']
  tag 'host'
