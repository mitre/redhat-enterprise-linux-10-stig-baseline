control 'SV-281144' do
  title 'RHEL 10 must generate audit records for successful and unsuccessful uses of the "unix_update" command.'
...
'
  desc 'check', 'Verify RHEL 10 is configured to audit the execution of the "unix_update" command with the following command:
...
If the command does not return a line, or the line is commented out, this is a finding.'
  desc 'fix', 'Configure RHEL 10 to generate audit records upon successful and unsuccessful attempts to use the "unix_update" command by adding or updating the following rule in "/etc/audit/rules.d/audit.rules":
...
$ sudo service auditd restart'
  impact 0.5
  tag check_id: 'C-85705r1166382_chk'
  tag severity: 'medium'
  tag gid: 'V-281144'
  tag rid: 'SV-281144r1166384_rule'
  tag stig_id: 'RHEL-10-500580'
  tag gtitle: 'SRG-OS-000037-GPOS-00015'
  tag fix_id: 'F-85610r1166383_fix'
