control 'SV-281164' do
  title 'RHEL 10 must generate audit records for all uses of the "chown", "fchown", "fchownat", and "lchown" syscalls.'
...
'
  desc 'check', 'Verify RHEL 10 is configured to audit the execution of the "chown", "fchown", "fchownat", and "lchown" syscalls with the following command:
...
If both the "b32" and "b64" audit rules are not defined for the "chown", "fchown", "fchownat", and "lchown" syscalls, this is a finding.'
  desc 'fix', 'Configure RHEL 10 to generate audit records upon successful/unsuccessful attempts to use the "chown", "fchown", "fchownat", and "lchown"" syscalls.
...
$ sudo service auditd restart'
  impact 0.5
  tag check_id: 'C-85725r1166442_chk'
  tag severity: 'medium'
  tag gid: 'V-281164'
  tag rid: 'SV-281164r1166444_rule'
  tag stig_id: 'RHEL-10-500790'
  tag gtitle: 'SRG-OS-000037-GPOS-00015'
  tag fix_id: 'F-85630r1166443_fix'
