control 'SV-281089' do
  ...
  desc 'check', 'Verify RHEL 10 is configured so that "/home" is mounted with the "nosuid" option with the following command:
...
If the "/home" file system is mounted without the "nosuid" option, this is a finding.'
  desc 'fix', 'Configure RHEL 10 to prevent files with the "setuid" and "setgid" bit set from being executed on file systems that contain user home directories.
