control 'SV-281139' do
  title 'RHEL 10 must generate audit records for successful and unsuccessful uses of the "ssh-keysign" command.'
...
'
  desc 'check', 'Verify RHEL 10 is configured to audit the execution of the "ssh-keysign" command with the following command:
...
If the command does not return a line, or the line is commented out, this is a finding.'
  desc 'fix', 'Configure RHEL 10 to generate audit records upon successful and unsuccessful attempts to use the "ssh-keysign" command by adding or updating the following rule in "/etc/audit/rules.d/audit.rules":
...
$ sudo service auditd restart'
  impact 0.5
  tag check_id: 'C-85700r1166367_chk'
  tag severity: 'medium'
  tag gid: 'V-281139'
  tag rid: 'SV-281139r1197228_rule'
  tag stig_id: 'RHEL-10-500530'
  tag gtitle: 'SRG-OS-000037-GPOS-00015'
  tag fix_id: 'F-85605r1166368_fix'
