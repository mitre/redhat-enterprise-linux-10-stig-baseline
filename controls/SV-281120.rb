control 'SV-281120' do
  title 'RHEL 10 must generate audit records for successful and unsuccessful uses of the "setfacl" command.'
...
'
  desc 'check', 'Verify RHEL 10 is configured to audit the execution of the "setfacl" command with the following command:
...
If the command does not return a line, or the line is commented out, this is a finding.'
  desc 'fix', 'Configure RHEL 10 to generate audit records upon successful and unsuccessful attempts to use the "setfacl" command by adding or updating the following rule in "/etc/audit/rules.d/audit.rules":
...
$ sudo service auditd restart'
  impact 0.5
  tag check_id: 'C-85681r1166310_chk'
  tag severity: 'medium'
  tag gid: 'V-281120'
  tag rid: 'SV-281120r1166312_rule'
  tag stig_id: 'RHEL-10-500340'
  tag gtitle: 'SRG-OS-000037-GPOS-00015'
  tag fix_id: 'F-85586r1166311_fix'
