control 'SV-281132' do
  title 'RHEL 10 must generate audit records for successful and unsuccessful uses of the "kmod" command.'
...
'
  desc 'check', 'Verify RHEL 10 is configured to audit the execution of the "kmod" command with the following command:

$ sudo auditctl -l | grep kmod
-a always,exit -S all -F path=/usr/bin/kmod -F perm=x -F auid>=1000 -F auid!=-1 -F key=modules

If the command does not return a line, or the line is commented out, this is a finding.'
  desc 'fix', 'Configure RHEL 10 to generate audit records upon successful and unsuccessful attempts to use the "kmod" command by adding or updating the following rule in "/etc/audit/rules.d/audit.rules":
...
$ sudo service auditd restart'
  impact 0.5
  tag check_id: 'C-85693r1166346_chk'
  tag severity: 'medium'
  tag gid: 'V-281132'
  tag rid: 'SV-281132r1166348_rule'
  tag stig_id: 'RHEL-10-500460'
  tag gtitle: 'SRG-OS-000037-GPOS-00015'
  tag fix_id: 'F-85598r1166347_fix'
