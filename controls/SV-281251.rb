...
functionality.'
  desc 'check', %q(Verify RHEL 10 enforces correct operation of security functions through the use of SELinux with the following command:
...
If an uncommented SELinux line is missing or not set to "enforcing", this is a finding.)
  desc 'fix', 'Configure RHEL 10 to enforce correct operation of security functions.
